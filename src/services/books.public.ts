import type { BookCategoriesResponse } from "@/services/books";

export async function fetchBookCategoriesPublic(page = 1, limit = 100): Promise<BookCategoriesResponse> {
  ...
  return {
    ...
    data: Array.isArray(data) ? (data as BookCategoriesResponse["data"]) : [],
  };
}
