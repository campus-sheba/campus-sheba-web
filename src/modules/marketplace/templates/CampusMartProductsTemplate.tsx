  ...
  return (
    <SectionWrapper spacing="none" background="transparent" className="my-0">
      <ContentWrapper maxWidth="max-w-7xl mx-auto" padding="md" className="pb-16 pt-2">
        ...
        <div className="mt-3">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#00A651]">{t("productsKicker")}</p>
          <h2 className="mt-1 text-xl font-bold tracking-tight text-gray-900">{t("productsTitle")}</h2>
          {filterSummary ? <p className="mt-1 text-sm text-gray-500">{filterSummary}</p> : null}
