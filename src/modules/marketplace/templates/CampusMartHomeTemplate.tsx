          ...
          <>
            ...
            <SectionWrapper spacing="sm" background="transparent" className="my-0 mt-10">
              <div className="rounded-2xl border border-gray-100 bg-gray-50/80 px-5 py-5">
                <p className="text-sm font-semibold text-gray-900">{t("buySellNoteTitle")}</p>
                <p className="mt-1 text-sm text-gray-600">{t("buySellNoteBody")}</p>
                <Link href="/buy-sell" className="mt-3 inline-block text-sm font-semibold text-[#00A651] hover:underline">
                  {t("buySellNoteCta")}
                </Link>
              </div>
            </SectionWrapper>
