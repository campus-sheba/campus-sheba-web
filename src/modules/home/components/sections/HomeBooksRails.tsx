        ...
        <SectionWrapper spacing="none" background="transparent" className="my-0 bg-white py-12 md:py-16">
          <ContentWrapper maxWidth="max-w-7xl mx-auto" padding="none" className="">
            <div className="flex items-start gap-4 rounded-2xl border border-dashed border-gray-200 bg-sky-50/40 p-8">
              ...
              <div>
                <h2 id="home-books-heading" className="text-lg font-bold text-gray-900 md:text-xl">
                  {tt("homeRails.booksTitle", "Book Sheba — sell, lend, donate")}
                </h2>
      ...
      <SectionWrapper spacing="none" background="transparent" className="my-0 bg-white py-12 md:py-16">
        <ContentWrapper maxWidth="max-w-7xl mx-auto" padding="none" className="">
          <div className="border-b border-gray-100 pb-8">
            ...
            <h2 id="home-books-heading" className="mt-2 text-2xl font-bold tracking-tight text-gray-900 md:text-3xl">
              {tt("homeRails.booksHeadline", "Textbooks: buy, borrow, or grab a donation")}
            </h2>
          ...
          <div className="mt-10 space-y-12">
            <BooksRow
              ...
              subtitle={tt("homeRails.booksSellSub", "Buy textbooks and notes from students on your campus.")}
              viewAllHref="/books/all?type=Selling"
              universityId={universityId}
              type="Selling"
              emptyHint={tt("homeRails.booksEmptySell", "No books listed for sale right now.")}
            />
            <BooksRow
              title={tt("homeRails.booksLend", "Books to borrow")}
              subtitle={tt("homeRails.booksLendSub", "Lend listings for a period — ideal for a single semester.")}
              viewAllHref="/books/all?type=Lending"
              universityId={universityId}
              type="Lending"
              emptyHint={tt("homeRails.booksEmptyLend", "No lend listings yet.")}
            />
            <BooksRow
              title={tt("homeRails.booksDonate", "Free books & donations")}
              subtitle={tt("homeRails.booksDonateSub", "Donated titles — pay it forward when you are done reading.")}
              viewAllHref="/books/all?type=Donation"
              universityId={universityId}
              type="Donation"
              emptyHint={tt("homeRails.booksEmptyDonate", "No donation listings yet.")}
            />
          </div>
        </ContentWrapper>
      </SectionWrapper>
