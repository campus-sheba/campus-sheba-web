        ...
        <SectionWrapper spacing="none" background="transparent" className="my-0 bg-amber-50/30 py-12 md:py-16">
          <ContentWrapper maxWidth="max-w-7xl mx-auto" padding="none" className="px-4 md:px-8">
            <div className="flex items-start gap-4 rounded-2xl border border-dashed border-amber-200/80 bg-white p-8">
              ...
              <div>
                <h2 id="home-lost-found-heading" className="text-lg font-bold text-gray-900 md:text-xl">
      ...
      <SectionWrapper spacing="none" background="transparent" className="my-0 bg-amber-50/30 py-12 md:py-16">
        <ContentWrapper maxWidth="max-w-7xl mx-auto" padding="none" className="">
          <div className="border-b border-amber-200/50 pb-8">
            ...
            <h2 id="home-lost-found-heading" className="mt-2 text-2xl font-bold tracking-tight text-gray-900 md:text-3xl">
              {tt("homeRails.lostFoundHeadline", "Recover items — or help someone else")}
            </h2>
          ...
          <div className="mt-10 space-y-12">
            <LostFoundRow
              ...
              subtitle={tt("homeRails.lostLatestSub", "Recently reported missing on campus.")}
              type="Lost"
            ...
            <LostFoundRow
              ...
              subtitle={tt("homeRails.foundLatestSub", "Good samaritan finds waiting to be claimed.")}
              type="Found"
              universityId={universityId}
              guestMode={guestMode}
