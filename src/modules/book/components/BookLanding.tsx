    ...
    <div className="grid gap-4 lg:grid-cols-3">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
        {ads.slice(1, 3).map((b) => (
          <div
            key={b._id}
            className="relative h-[122px] overflow-hidden rounded-2xl border border-gray-200 bg-gray-50"
          >
            <Image
    ...
    <SectionWrapper spacing="none" background="transparent" className="my-0">
      ...
      >
        ...
        <div className="mt-3">
          <SectionHeader
            title="Books"
            subtitle="Campus book exchange - browse by featured, latest, and categories."
