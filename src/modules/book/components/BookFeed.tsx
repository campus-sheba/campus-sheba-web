...
import { fetchBookCategoriesPublic } from "@/services/book.public";
...
export default function BookFeed() {
  ...
  const { items, total, isLoading, error, hasMore, loadMore } = useBookList({
    universityId,
    debouncedSearch,
      ...
      >
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Browse textbooks, guides, and notes from your campus. Select a
              university in the header to load items.
            </p>
          </div>
        </div>
        ...
        {!universityId && (
          <div className="mt-10 rounded-2xl border border-dashed border-gray-200 bg-gray-50/80 px-6 py-12 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Use the campus selector in the top bar to see book listings for
              that campus.
            </p>
          </div>
        )}
