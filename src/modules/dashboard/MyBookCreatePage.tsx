...
import { createBookListingAction, fetchBookCategories } from "@/services/book";
...
export default function MyBookCreatePage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true);
    const res = await createBookListingAction({
      title: title.trim(),
    ...
    if (res.listingId) {
      router.push(`/books/${res.listingId}`);
    } else {
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Engineering Mathematics 2nd Edition"
                />
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Condition, notes/highlights, reason for selling..."
                />
              </div>
              <div>
