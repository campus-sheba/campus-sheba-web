...
export const servicesMenu: ServiceMenuItem[] = [
  ...
  { label: "Transport", description: "Live bus, fares, rent, ride share & tickets", href: "/transport", icon: Bus, color: "text-emerald-700", bg: "bg-emerald-50" },
  { label: "Live Bus", description: "Track campus shuttles in real time", href: "/live-bus", icon: Navigation, color: "text-emerald-700", bg: "bg-emerald-50" },
